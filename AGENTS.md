...
- The AI booking assistant: the model may *decide* actions but **the server executes** them with
...
- Commits follow Conventional Commits; PRs note where AI assisted and what I changed/verified.
